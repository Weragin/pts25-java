...
public class ProcessActionBase {
    ...
    private static void putAllResources(Grid grid,
                                 Map<GridPosition, List<Resource>> gridResourcesIn,
    ...
    private static boolean canGetResources(Grid grid,
                                           Map<GridPosition,List<Resource>> gridResourcesIn){
        for(GridPosition gridPosition: gridResourcesIn.keySet()){
            Card gridCard = grid.getCard(gridPosition);
            if(gridCard == null){
